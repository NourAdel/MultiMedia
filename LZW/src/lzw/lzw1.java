 ...
 * @author Wahba
 */
public class lzw1 extends javax.swing.JFrame {

    /**
     * Creates new form lzw1
     */
    String s;
    public lzw1() {
        initComponents();
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(54, 54, 54)
                .addComponent(compress, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(190, 190, 190)
    ...
    private void compressActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_compressActionPerformed
       LZW l= new LZW();
        try {
            ...
            Logger.getLogger(lzw1.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lzw1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
